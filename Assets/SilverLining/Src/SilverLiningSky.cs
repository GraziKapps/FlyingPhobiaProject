...
public class SilverLiningSky
{
    ...
    private void UpdateMoon ()
    {
        ...
        //if ((moonColorV.x == 0 && moonColorV.y == 0 && moonColorV.z == 0))
        //{
        //    GameObject controller = GameObject.Find("ShadingCalculationsViewController");
        //    controller.GetComponent<ShadingCalculationsViewController>().isEnabled = true;
        //    Debug.Log("Sol apareceu!!");
        //}
...
//        GameObject controller = GameObject.Find("ShadingCalculationsViewController");
//        GameObject sunobj = GameObject.Find("SilverLiningSun");    
//        if ((sunColorV.x == 0 && sunColorV.y == 0 && sunColorV.z == 0))
//        {
//            // controller.GetComponent<ShadingCalculationsViewController>().isEnabled = false;
//            //if(sunobj.active != null)
